...
const HomePage = () => {
  ...
  return /* @__PURE__ */ jsx(Main, { paddingLeft: 6, paddingRight: 6, paddingTop: 6, paddingBottom: 6, style: { height: "100vh", display: "flex", justifyContent: "center", alignItems: "center" }, children: /* @__PURE__ */ jsxs(Flex, { direction: "column", justifyContent: "center", alignItems: "center", children: [
